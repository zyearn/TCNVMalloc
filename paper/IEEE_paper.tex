...
\title{Wamalloc: An efficient wear-aware allocator for Non-volatile Main Memory}
...
Email: zhujiashun2010@gmail.com, lisumin\_2013, lphuang@sjtu.edu.cn}
}
...
However, the low endurance problem limites its practical applications.
In this paper, we propose Wamalloc, an efficient NVM memory allocator to extend PCM's lifetime in the software level.
