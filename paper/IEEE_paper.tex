...
\author{\IEEEauthorblockN{Jiashun Zhu, xxxx, xxxx }
\IEEEauthorblockA{
Department of Computer Science and Engineering\\
Shanghai Jiao Tong University\\
Email: zhujiashun2010, xxxx, xxxxx@gmail.com}
}
...
The reason is that they mainly focused on the whole toolboxs of NVM or the wear-leveling policy is not accurate enough.
...
since putting metadatas into DRAM will decrease plenty of writes to NVM, which will probably extend the lifetime of PCM.
...
Metadatas are stored in local heap, such as size class and pointers to usable chunks.
